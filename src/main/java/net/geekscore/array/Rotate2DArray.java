...
public class Rotate2DArray {
    ...
    public static void main(String[] args) {
        ...
        for (int degrees = 90; degrees <= 360 ; degrees+=90) {
            ...
            int[][] rotated2DArray = rotateInMemory(new int[][]{{1,2,3},{4,5,6},{7,8,9}} , true, degrees);
            System.out.println(String.format(" ------ Clockwise Rotating: %d ", degrees));
            ArrayUtil.print(rotated2DArray);

            rotated2DArray = rotateInMemory(new int[][]{{5, 1, 9,11},{2, 4, 8,10},{13, 3, 6, 7},{15,14,12,16}} , true, degrees);
            System.out.println(String.format(" ------ Clockwise Rotating: %d ", degrees));
            ArrayUtil.print(rotated2DArray);
        }
        ...
        for (int degrees = 90; degrees <= 360 ; degrees+=90) {
            ...
            int[][] rotated2DArray = rotateInMemory(new int[][]{{1,2,3},{4,5,6},{7,8,9}} , false, degrees);
            System.out.println(String.format(" ------ Anti-Clock wise Rotating: %d ", degrees));
            ArrayUtil.print(rotated2DArray);


            rotated2DArray = rotateInMemory(new int[][]{{5, 1, 9,11},{2, 4, 8,10},{13, 3, 6, 7},{15,14,12,16}} , false, degrees);
            System.out.println(String.format(" ------ Anti-Clock wise Rotating: %d ", degrees));
            ArrayUtil.print(rotated2DArray);
        }


        int[][] rotated2DArray = rotateBy180InMemory(new int[][]{{1,2,3},{4,5,6},{7,8,9}} , true);
        System.out.println(" --------- Clock wise 180 ------");
        ArrayUtil.print(rotated2DArray);

        rotated2DArray = rotateBy180InMemory(new int[][]{{5, 1, 9,11},{2, 4, 8,10},{13, 3, 6, 7},{15,14,12,16}} , true);
        System.out.println(" --------- Clock wise 180 ------");
        ArrayUtil.print(rotated2DArray);


        rotated2DArray = rotateBy180InMemory(new int[][]{{1,2,3},{4,5,6},{7,8,9}} , false);
        System.out.println(" --------- Anti-Clock wise 180 ------");
        ArrayUtil.print(rotated2DArray);

        rotated2DArray = rotateBy180InMemory(new int[][]{{5, 1, 9,11},{2, 4, 8,10},{13, 3, 6, 7},{15,14,12,16}} , false);
        System.out.println(" --------- Anti-Clock wise 180 ------");
        ArrayUtil.print(rotated2DArray);
    ...
    private static final int[][] rotateLayerByLayer(int[][] matrix, final boolean clockWise, final int degrees) {
        // TODO
        return matrix;
    }
